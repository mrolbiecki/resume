// Copy of `@preview/basic-resume:0.2.9` with some layout tweaks.
// Upstream: https://typst.app/universe/package/basic-resume
...
#let work(
  ...
  // Local change: emphasize the company instead of the title.
  generic-two-by-two(
    top-left: emph(title),
    top-right: dates,
